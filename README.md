...
Below, we compare the 3 models explored in this study in a single overlay. Figure 6 shows a comparison of the predicted fitness scores across 3 models, while Figure 7 shows the score residuals. Figure 8 includes a table comparing Spearman and Pearson correlations across the 3 approaches.


![Figure 6.](figures/summary_scores.png)
![Figure 7.](figures/residuals.png)

Figure 8. Comparison of metrics across models
